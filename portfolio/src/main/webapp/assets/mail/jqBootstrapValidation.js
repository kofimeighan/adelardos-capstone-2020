 ...
 * v1.3.6
 *
 * License: MIT <http://opensource.org/licenses/mit-license.php> - see LICENSE
 * file
 *
...
var defaults = {
  options: {
    ...
    preventSubmit:
        true,  // stop the form submit event from firing if validation fails
    submitError:
        false,  // function called if there is an error when trying to submit
    submitSuccess: false,  // function called just before a successful submit
  ...
  methods: {
    init: function(options) {
      ...
      var uniqueForms = $.unique($siblingElements
                                     .map(function() {
        ...
        if (warningsFound) {
          ...
          if ($.isFunction(settings.options.submitError)) {
            settings.options.submitError(
                $form, e, $inputs.jqBootstrapValidation('collectErrors', true));
          }
        } else {
      ...
      return this.each(function() {
        ...
        var $this = $(this),
            ...
            $form = $this.parents('form').first(), validatorNames = [];
        ...
        if (settings.options.sniffHtml) {
          ...
          if ($this.attr('min') !== undefined ||
            ...
            var min =
                ($this.attr('min') !== undefined ? $this.attr('min') :
          ...
          if ($this.attr('minchecked') !== undefined) {
            ...
            $this.data(
                'validationMincheckedMinchecked', $this.attr('minchecked'));
          }
          // ---------------------------------------------------------
          //                                                MAXCHECKED
          // ---------------------------------------------------------
          if ($this.attr('maxchecked') !== undefined) {
            ...
            $this.data(
                'validationMaxcheckedMaxchecked', $this.attr('maxchecked'));
          }
        }
        ...
        $.each(validatorNames, function(i, el) {
              ...
              function(validatorType, validatorTemplate) {
                ...
                if (!foundValidator &&
                    $this.data(
                        ...
                        undefined) {
                  validators[validatorType].push($.extend(
                      true, {
          ...
          if (!foundValidator && settings.builtInValidators[el.toLowerCase()]) {
            var validator = $.extend(
                true, {}, settings.builtInValidators[el.toLowerCase()]);
              ...
              $.each(
                  ...
                  function(validatorTemplateType, validatorTemplate) {
                    ...
                    if (!foundValidator &&
                      ...
                      validators[validatorType].push($.extend(
                          validator, validatorTemplate.init($this, el)));
                      foundValidator = true;
                    }
                  });
            }
        ...
        $this.bind('validation.validation', function(event, params) {
          ...
          $.each(validators, function(validatorType, validatorTypeArray) {
            if (value || value.length || (params && params.includeEmpty) ||
                (!!settings.validatorTypes[validatorType].blockSubmit &&
                 params && !!params.submitting)) {
              $.each(validatorTypeArray, function(i, validator) {
                if (settings.validatorTypes[validatorType].validate(
            ...
            function(e, params) {
              ...
              if (errorsFound.length) {
                ...
                if (settings.options.semanticallyStrict &&
                  ...
                  $helpBlock.html(
                      '<ul role="alert"><li>' + errorsFound.join('</li><li>') +
                      '</li></ul>' +
                      (settings.options.prependExistingHelpBlock ?
                           $helpBlock.data('original-contents') :
                           ''));
    ...
    collectErrors: function(includeEmpty) {
      ...
      this.each(function(i, el) {
        ...
        var errors =
            $el.triggerHandler('validation.validation', {includeEmpty: true});
      ...
      this.each(function(i, el) {
        errorMessages = errorMessages.concat(
            $(el).triggerHandler('getValidators.validation') ?
                $(el).triggerHandler(
                    'validation.validation', {submitting: true}) :
                []);
      });
  ...
  validatorTypes: {
      ...
      validate: function($this, value, validator) {
        ...
        if (validator.lastFinished === true) {
          ...
          executeFunctionByName(
              validator.callback, window, $this, value, function(data) {
    ...
    max: {
      ...
      validate: function($this, value, validator) {
        return (parseFloat(value, 10) > parseFloat(validator.max, 10) &&
                !validator.negative) ||
    ...
    min: {
      ...
      validate: function($this, value, validator) {
        return (parseFloat(value) < parseFloat(validator.min) &&
                !validator.negative) ||
    ...
    maxchecked: {
      ...
      validate: function($this, value, validator) {
        return (validator.elements.filter(':checked').length >
  ...
  builtInValidators: {
    ...
    positive:
        {name: 'Positive', type: 'shortcut', shortcut: 'number,positivenumber'},
    negative:
        {name: 'Negative', type: 'shortcut', shortcut: 'number,negativenumber'},
    number: {
      name: 'Number',
      type: 'regex',
      regex: '([+-]?\\\d+(\\\.\\\d*)?([eE][+-]?[0-9]+)?)?',
